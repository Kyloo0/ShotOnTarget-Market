...
from main.views import show_main_page, show_xml, show_json, show_xml_by_id, show_json_by_id, create_product, show_detail, register, login_user, logout_user, edit_product, delete_product, add_product_ajax, get_product_json, update_product_ajax, delete_product_ajax, login_ajax, register_ajax, proxy_image, create_product_flutter, my_products_json_flutter
app_name = "main"
...
urlpatterns = [
    ...
    path('my-products-json/', my_products_json_flutter, name='my_products_json_flutter'),
]